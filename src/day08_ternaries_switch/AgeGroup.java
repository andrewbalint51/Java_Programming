...
public class AgeGroup {
    ...
    public static void main(String[] args) {
        ...
        r = (age>=1&&age<=2)? "infant" :(age>=3&&age<=5)? "Toddler" :(age>=6&&age<=9)? "Kid"
           ...
           :(age>=65&&age<=74)? "Young Senior Citizen" :(age>=75&&age<=84)? "Senior Citizen" :(age>=85)?
           "Old Senior Citizen" : "Invalid";
